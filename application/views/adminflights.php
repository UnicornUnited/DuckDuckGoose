...
<!--                        I will change this field so it cannot be changed. The arrival time will be autogenerated-->
<!--                        based on airports distance, plane speed, etc.-->
                        <td title="{arrive_time}"><input type="text" name="arrive_time" value="Auto Assigned" disabled="true"></td>
